...
class userModule {
    ...
    async request(endpoint: string, method: EMethodTypes, body?: object | undefined | null, headers = {}) {
    ...
    async signUp({ email, password, fullName }: TSignUpProps) {
        return this.request("/user/signup", EMethodTypes.POST, { email, password, fullName });
    }
