...
export default function ExpeditionList({ expeditions }: { expeditions: TExpedition[] | null }) {
  if (expeditions)
 return (
   <div>
       ...
       <TableBody>
         {expeditions.map((expedition) => (
           <TableRow key={expedition._id}>
             ...
             <TableCell>{new Date(expedition.expeditionDate).toLocaleDateString()}</TableCell>
             ...
             <TableCell>
               <Badge
                 variant={
                   expedition.expeditionStatus === 'COMPLETED' ? 'default' :
                   expedition.expeditionStatus === 'IN_PROGRESS' ? 'secondary' :
                   expedition.expeditionStatus === 'PLANNED' ? 'outline' :
                   'destructive'
                 }
               >
